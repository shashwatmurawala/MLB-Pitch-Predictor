...
# ── Feature Engineering (Identical to original model) ──
batter_names = {}
...
pitcher_brains = {}
print(f"Training {len(valid_pitchers)} Pitcher Brains...")
for i, pname in enumerate(valid_pitchers):
    ...
    # Lightweight Random Forest for tiny memory footprint per player
...
print("Saving pitcher_brains.pkl...")
joblib.dump(pitcher_brains, 'pitcher_brains.pkl', compress=3)
...
batter_brains = {}
print(f"Training {len(valid_batters)} Batter Brains...")
...
print("Saving batter_brains.pkl...")
joblib.dump(batter_brains, 'batter_brains.pkl', compress=3)

print("Dual Brains training complete!")
